...
class MainActivity : BaseSimpleActivity() {
    val listItems = mutableListOf(
            ...
            , mapOf("owner" to "googlesamples", "name" to "android-architecture", "displayName" to "todo-mvp-kotlin")
            ...
            , mapOf("owner" to "bumptech", "name" to "glide", "displayName" to "glide-imgur")
            , mapOf("owner" to "bumptech", "name" to "glide", "displayName" to "glide-flickr")
