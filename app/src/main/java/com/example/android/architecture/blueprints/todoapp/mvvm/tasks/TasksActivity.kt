...
import com.example.android.architecture.blueprints.todoapp.mvvm.statistics.StatisticsActivity
import com.example.android.architecture.blueprints.todoapp.mvvm.taskdetail.TaskDetailActivity
...
class TasksActivity : LifecycleAppCompatActivity(), TaskItemNavigator, TasksNavigator {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.todomvvm_tasks_act)
