...
import io.github.aafactory.sample.databinding.TodomvvmTaskItemBinding
...
class TasksAdapter(
    ...
    override fun getView(position: Int, view: View?, viewGroup: ViewGroup): View {
        val binding: TodomvvmTaskItemBinding
        if (view == null) {
            // Inflate
            val inflater = LayoutInflater.from(viewGroup.context)

            // Create the binding
            binding = TodomvvmTaskItemBinding.inflate(inflater, viewGroup, false)
        } else {
            // Recycling view
            binding = DataBindingUtil.getBinding<TodomvvmTaskItemBinding>(view)!!
        }
