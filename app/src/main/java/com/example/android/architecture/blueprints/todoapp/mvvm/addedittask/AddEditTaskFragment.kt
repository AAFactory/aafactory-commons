...
import io.github.aafactory.sample.databinding.TodomvvmAddtaskFragBinding
...
class AddEditTaskFragment : Fragment() {
    ...
    private lateinit var viewDataBinding: TodomvvmAddtaskFragBinding
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val root = inflater.inflate(R.layout.todomvvm_addtask_frag, container, false)
        viewDataBinding = TodomvvmAddtaskFragBinding.bind(root).apply {
