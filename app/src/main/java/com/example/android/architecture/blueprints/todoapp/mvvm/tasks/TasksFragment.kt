...
import io.github.aafactory.sample.databinding.TodomvvmTasksFragBinding
...
class TasksFragment : LifecycleFragment() {
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        inflater.inflate(R.menu.todomvvm_tasks_fragment_menu, menu)
    }
    ...
    private fun showFilteringPopUpMenu() {
        PopupMenu(context!!, activity!!.findViewById<View>(R.id.menu_filter)).run {
            menuInflater.inflate(R.menu.todomvvm_filter_tasks, menu)
