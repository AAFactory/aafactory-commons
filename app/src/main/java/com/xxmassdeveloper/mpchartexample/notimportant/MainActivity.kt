...
class MainActivity : AppCompatActivity(), OnItemClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        objects.add(ContentItem("Line Chart", "A simple demonstration of the linechart."))
        objects.add(ContentItem("Line Chart (Dual YAxis)", "Demonstration of the linechart with dual y-axis."))
        objects.add(ContentItem("Bar Chart", "A simple demonstration of the bar chart."))
        objects.add(ContentItem("Horizontal Bar Chart", "A simple demonstration of the horizontal bar chart."))
        //        objects.add(new ContentItem("Combined Chart",
        //                "Demonstrates how to create a combined chart (bar and line in this case)."));
        objects.add(ContentItem("Pie Chart", "A simple demonstration of the pie chart."))
        objects.add(ContentItem("Pie Chart with value lines", "A simple demonstration of the pie chart with polyline notes."))
        objects.add(ContentItem("Scatter Chart", "A simple demonstration of the scatter chart."))
        objects.add(ContentItem("Bubble Chart", "A simple demonstration of the bubble chart."))
        //        objects.add(new ContentItem("Stacked Bar Chart",
        //                "A simple demonstration of a bar chart with stacked bars."));
        objects.add(ContentItem("Stacked Bar Chart Negative", "A simple demonstration of stacked bars with negative and positive values."))
        ...
        objects.add(ContentItem("Inverted Line Chart", "Demonstrates the feature of inverting the y-axis."))
        objects.add(ContentItem("Candle Stick Chart", "Demonstrates usage of the CandleStickChart."))
        //        objects.add(new ContentItem(
        //                "Cubic Line Chart",
        //                "Demonstrates cubic lines in a LineChart."));
        objects.add(ContentItem("Radar Chart", "Demonstrates the use of a spider-web like (net) chart."))
        //        objects.add(new ContentItem(
        //                "Colored Line Chart",
        ...
        //                        "milliseconds."));
        objects.add(ContentItem("Filled LineChart", "This demonstrates how to fill an area between two LineDataSets."))
        //        objects.add(new ContentItem(
        //                "Half PieChart",
        ...
        val lv = findViewById<View>(R.id.listView1) as ListView
        lv.adapter = adapter
    ...
    override fun onItemClick(av: AdapterView<*>, v: View, pos: Int, arg3: Long) {
        val i: Intent
        val item = av.adapter.getItem(pos) as ContentItem

        when (item.name) {
            "Line Chart" -> {
                i = Intent(this, LineChartActivity1::class.java)
                startActivity(i)
            }
            "Line Chart (Dual YAxis)" -> {
                i = Intent(this, LineChartActivity2::class.java)
                startActivity(i)
            }
            "Bar Chart" -> {
                i = Intent(this, BarChartActivity::class.java)
                startActivity(i)
            }
            "Horizontal Bar Chart" -> {
                i = Intent(this, HorizontalBarChartActivity::class.java)
                startActivity(i)
            }
            "Pie Chart" -> {
                i = Intent(this, PieChartActivity::class.java)
                startActivity(i)
            }
            "Pie Chart with value lines" -> {
                i = Intent(this, PiePolylineChartActivity::class.java)
                startActivity(i)
            }
            "Scatter Chart" -> {
                i = Intent(this, ScatterChartActivity::class.java)
                startActivity(i)
            }
            "Bubble Chart" -> {
                i = Intent(this, BubbleChartActivity::class.java)
                startActivity(i)
            }
            "Stacked Bar Chart Negative" -> {
                i = Intent(this, StackedBarActivityNegative::class.java)
                startActivity(i)
            }
            "Candle Stick Chart" -> {
                i = Intent(this, CandleStickChartActivity::class.java)
                startActivity(i)
            }
            "Radar Chart" -> {
                i = Intent(this, RadarChartActivity::class.java)
                startActivity(i)
            }
            "Filled LineChart" -> {
                i = Intent(this, FilledLineActivity::class.java)
                startActivity(i)
            }
            "Inverted Line Chart" -> {
                i = Intent(this, InvertedLineChartActivity::class.java)
                startActivity(i)
            }
        }//            case 4:
