...
public class FlickrPhotoGrid extends Fragment implements PhotoViewer {
    ...
    public View onCreateView(
        ...
        final View result = inflater.inflate(R.layout.glideflickr_flickr_photo_grid, container, false);
    ...
    private class PhotoAdapter extends RecyclerView.Adapter<PhotoViewHolder> implements
        ...
        public PhotoViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = inflater.inflate(R.layout.glideflickr_flickr_photo_grid_item, parent, false);
